...
CC2652R7 (TI BIM):
	Onchip OAD:
		0x00 	      -> simple_peripheral_oad_onchip_LP_CC2652R7_tirtos7_ticlang_oad-v1.0.0.bin
		0x86000       -> persistent_app_LP_CC2652R7_tirtos7_ticlang_oad-v1.0.0.bin
		AUTO(0xae000) -> bim_onchip_LP_CC2652R7_nortos_ticlang.hex
	Offchip OAD:
		0x00 	      -> simple_peripheral_oad_offchip_LP_CC2652R7_tirtos7_ticlang_oad-v1.0.0.bin
